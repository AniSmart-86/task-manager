...
const { getDashboardData, getUerDashboardData, getTasks, getTaskById, createTask, updateTask, deleteTask, updateTaskStatus, updateTaskChecklist } = require("../controllers/taskController");
...
taskRouter.get("/user-dashboard-data", protect, getUerDashboardData)
